...
def main():
    ...
    txns.append(transfer_and_set('ETH',    1, 7_920e18, 374_400e8, notional))
    txns.append(transfer_and_set('DAI',    2, 3_300e18, 156_000e8, notional))
    txns.append(transfer_and_set('USDC',   3, 7_920e18, 374_400e8, notional))
    txns.append(transfer_and_set('WBTC',   4,   660e18,  31_200e8, notional))
    txns.append(transfer_and_set('wstETH', 5, 3_300e18, 156_000e8, notional))
    txns.append(transfer_and_set('FRAX',   6, 3_300e18, 156_000e8, notional))
    txns.append(transfer_and_set('rETH',   7, 3_300e18, 156_000e8, notional))
    txns.append(transfer_and_set('USDT',   8, 3_300e18, 156_000e8, notional))
