...
def main():
    ...
    txns.append(transfer_and_set('ETH',    1, 12_000e18, 723_840e8, notional))
    txns.append(transfer_and_set('DAI',    2,  5_000e18, 301_600e8, notional))
    txns.append(transfer_and_set('USDC',   3, 12_000e18, 723_840e8, notional))
    txns.append(transfer_and_set('WBTC',   4,  1_000e18,  60_320e8, notional))
    txns.append(transfer_and_set('wstETH', 5,  5_000e18, 301_600e8, notional))
    txns.append(transfer_and_set('FRAX',   6,  5_000e18, 339_560e8, notional))
    txns.append(transfer_and_set('rETH',   7,  5_000e18, 301_600e8, notional))
    txns.append(transfer_and_set('USDT',   8,  5_000e18, 301_600e8, notional))
